    ...
    <div class="card">
      ...
      <div class="product-table">
          ...
          <div class="table-content">
            <div class="content1">
            <input type="text" name="" id=""  placeholder="Mã đặt hàng" class="danger" value="TBRH_VN<?=$bill_id?>">
            ...
            <div class="content2">
                  <input type="text" name="" id="" placeholder="Tên khách hàng" class="danger" value="<?=$full_name?>">
                  <br>
                  <input type="text" name="" id="" placeholder="Số điện thoại" class="danger" value="<?=$phone_number?>">
                  <br>
                  <input type="text" name="" id="" placeholder="Địa chỉ" class="danger" value="<?=$address?>">
            </div>     
          </div>
        </div>
        <div class="product-table">
